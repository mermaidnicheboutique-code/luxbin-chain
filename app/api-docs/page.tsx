          ...
          <div className="max-w-6xl mx-auto">
            <div className="flex gap-4 mb-8 overflow-x-auto">
              {[
                ...
                { id: "dictionary", name: "Light Language API" },
...
{`{
  ...
  "result": { ... }
            ...
            {/* Light Language API Tab */}
            {activeTab === "dictionary" && (
              <div className="space-y-6">
                <h2 className="text-3xl font-bold mb-6">Light Language Dictionary API</h2>
                <p className="text-gray-300 mb-6">
                  Access our curated collection of Light Language symbols and their spiritual meanings.
                </p>

                {/* GET /api/dictionary */}
                <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6">
                  <h3 className="text-xl font-bold mb-2 text-purple-300">GET /api/dictionary</h3>
                  <p className="text-gray-300 text-sm mb-4">Retrieve all Light Language dictionary entries</p>
...
{`{
  ...
  "data": [
    {
      "symbol": "Spiral",
      "meaning": "Represents transformation, evolution...",
  ...
  "message": "Light Language dictionary retrieved successfully"
                  ...
                  <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-4">
                    <p className="text-sm text-green-300">
                      <strong>Test it:</strong> <a href="/api/dictionary" target="_blank" className="underline hover:text-green-200">/api/dictionary</a>
                    </p>
                  </div>
                </div>
                ...
                {/* POST /api/dictionary */}
                <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6">
                  <h3 className="text-xl font-bold mb-2 text-purple-300">POST /api/dictionary</h3>
                  <p className="text-gray-300 text-sm mb-4">Add a new Light Language symbol entry</p>
                  <div className="bg-black/80 rounded-xl p-4 mb-4">
                    <p className="text-xs text-gray-400 mb-2">Request Body:</p>
                    <pre className="text-sm text-green-300">
{`{
  "symbol": "New Symbol",
  "meaning": "Description of the symbol's meaning",
  ...
  "message": "Dictionary entry added successfully"
                  ...
                  <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-xl p-4">
                    <p className="text-sm text-yellow-300">
                      <strong>Note:</strong> Currently, new entries are not persisted to storage. This is for demonstration purposes.
                    </p>
                  </div>
                </div>
                ...
                {/* Usage Examples */}
                <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6">
                  <h3 className="text-xl font-bold mb-4 text-purple-300">Usage Examples</h3>

                  <h4 className="text-lg font-semibold mb-2">JavaScript (Fetch)</h4>
                  <div className="bg-black/80 rounded-xl p-4 mb-4">
                    <pre className="text-sm text-blue-300">
...
fetch('/api/dictionary', {
  ...
  .then(data => console.log(data));`}
                  ...
                  <div className="bg-black/80 rounded-xl p-4">
                    <pre className="text-sm text-blue-300">
{`# Get dictionary
curl https://your-app.vercel.app/api/dictionary

# Add entry
curl -X POST https://your-app.vercel.app/api/dictionary \\
  -H "Content-Type: application/json" \\
  -d '{"symbol":"Test","meaning":"Test meaning","category":"Test"}'`}
                    </pre>
                  </div>
                </div>
              </div>
